classdef bot
    ...
    %
    % or, with a struct winth following properties
    % connectto (comport)
    % baudrate
    % commandmapping
    ...
    methods (Static)
        function template=getTemplate()
            template.connectto='COM11';
            template.baudrate=9600;
            template.commandmapping={'1' '2','3','4','5';...
                '0' '1' '3' '4' '2' }';
        end
    end
    ...
    methods
        function this=bot(comport_or_struct,BaudRate,CommandMap)
            ...
            if isstruct(comport_or_struct)
                this.connection=serial(comport_or_struct.connectto);
                this.connection.baudrate=comport_or_struct.baudrate;
                this.commandmap=comport_or_struct.commandmapping;
